...
const {createStory, getStory, getAllStories, deleteStory} = require("../controllers/Stories/story");
...
router.delete("/delete-story/:storyId", limiter, authMiddleware, deleteStory);
